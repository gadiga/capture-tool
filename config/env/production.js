...
module.exports = {
	db: process.env.MONGOHQ_URL || process.env.MONGOLAB_URI || 'mongodb://' + (process.env.DB_1_PORT_27017_TCP_ADDR || 'localhost') + '/gaf-xml-tool',
	assets: {
		lib: {
			css: [
			...
			js: [
				...
				'public/lib/angular.treeview-master/angular.treeview.min.js',
				'public/lib/angular-xeditable/js/xeditable.min.js',
